...
-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('lava/assets/css/bootstrap.min.css') }}">

    <link rel="stylesheet" type="text/css" href="{{ asset('lava/assets/css/font-awesome.css') }}">

    <link rel="stylesheet" href="{{ asset('lava/assets/css/templatemo-lava.css') }}">

    <link rel="stylesheet" href="{{ asset('lava/assets/css/owl-carousel.css') }}">
...
<body>
    ...
    <!-- jQuery -->
    <script src="{{ ('lava/assets/js/jquery-2.1.0.min.js') }}"></script>

    <!-- Bootstrap -->
    <script src="{{ asset('lava/assets/js/popper.js') }}"></script>
    <script src="{{ asset('lava/assets/js/bootstrap.min.js') }}"></script>

    <!-- Plugins -->
    <script src="{{ asset('lava/assets/js/owl-carousel.js') }}"></script>
    <script src="{{ asset('lava/assets/js/scrollreveal.min.js') }}"></script>
    <script src="{{ asset('lava/assets/js/waypoints.min.js') }}"></script>
    <script src="{{ asset('lava/assets/js/jquery.counterup.min.js') }}"></script>
    <script src="{{ asset('lava/assets/js/imgfix.min.js') }}"></script>

    <!-- Global Init -->
    <script src="{{ asset('lava/assets/js/custom.js') }}"></script>
